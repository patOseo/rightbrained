...
<nav id="main-nav" class="navbar navbar-expand-md navbar-dark bg-dark py-0" aria-labelledby="main-nav-label">
	...
	<div class="container-fluid px-5">
		...
		<img src="/wp-content/themes/rightbrained/images/logo-small.png" alt="RIght Brained" class="d-lg-none">
