...
(function (global, factory) {
	...
	*/
	...
	var require$$0$1 = /*@__PURE__*/getAugmentedNamespace(Popper);
	...
	(function (module, exports) {
	(function (global, factory) {
	  module.exports = factory(require$$0$1, eventHandler.exports, manipulator.exports, selectorEngine.exports, baseComponent.exports) ;
	...
	(function (module, exports) {
	(function (global, factory) {
	  module.exports = factory(require$$0$1, data.exports, eventHandler.exports, manipulator.exports, selectorEngine.exports, baseComponent.exports) ;
	...
	var bootstrap_esm = /*#__PURE__*/Object.freeze({
		__proto__: null,
		Alert: Alert,
		Button: Button,
		Carousel: Carousel,
	...
	var require$$0 = /*@__PURE__*/getAugmentedNamespace(bootstrap_esm);

	(function (module, exports) {
	// Add your custom JS here.
	jQuery(function ($) {
	  // Move the Modals from the Modal Block to the start of the <body> tag to avoid z-index issues
	  $(document).ready(function () {
	    $('.video-modal').prependTo("body");
	  }); // Turn off video on modal close
	  ...
	  $(document).ready(function () {
	    ...
	    $('.video-btn').click(function () {
	      ...
	      $videoI = $(this).data("inc");
	    });
	    $('.video-modal').on('shown.bs.modal', function (e) {
	      $(".video" + $videoI).attr('src', $videoSrc + "?title=0&byline=0&portrait=0");
	    });
	    $('.video-modal').on('hide.bs.modal', function (e) {
	      $(".video" + $videoI).attr('src', $videoSrc);
	    });
	  });
	}); // import 'bs5-lightbox';
	      ...
	      class s {
	        constructor(t, s = {}) {
	          this.hash = this.randomHash(), this.settings = Object.assign(Object.assign(Object.assign({}, e.Modal.Default), e.Carousel.Default), {
	            ...
	            size: "xl",
	            constrain: !0
	          }), this.modalOptions = (() => this.setOptionsFromSettings(e.Modal.Default))(), this.carouselOptions = (() => this.setOptionsFromSettings(e.Carousel.Default))(), "string" == typeof t && (this.settings.target = t, t = document.querySelector(this.settings.target)), this.settings = Object.assign(Object.assign({}, this.settings), s), this.el = t, this.type = t.dataset.type || "", this.src = this.getSrc(t), this.sources = this.getGalleryItems(), this.createCarousel(), this.createModal();
	        }
